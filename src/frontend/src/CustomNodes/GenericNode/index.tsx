...
function GenericNode({
  ...
  const dismissedNodes = useFlowStore(useShallow((state) => state.dismissedNodes));
  const addDismissedNodes = useFlowStore(useShallow((state) => state.addDismissedNodes));
  const removeDismissedNodes = useFlowStore(useShallow(
