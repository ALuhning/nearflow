...
export default function IOModal({
  ...
  const newChatOnPlayground = useFlowStore(useShallow(
    (state) => state.newChatOnPlayground,
  ));
  const setNewChatOnPlayground = useFlowStore(useShallow(
    (state) => state.setNewChatOnPlayground,
  ));

  const { flowIcon, flowId, flowGradient } = useFlowStore(
    useShallow((state) => ({
  ...
  const removeMessages = useMessagesStore(useShallow((state) => state.removeMessages));
